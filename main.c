...
/*   Updated: 2024/07/06 15:47:10 by itykhono         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		obj->math_num.real_num.max *= ZOOM_STEP;
// 		obj->math_num.imag_num.max *= ZOOM_STEP;
// 		obj->math_num.real_num.min *= ZOOM_STEP;
// 		obj->math_num.imag_num.min *= ZOOM_STEP;
...
// 		obj->math_num.imag_num.min /= ZOOM_STEP;
// 	}
// 	obj->math_num.x_offset = (x - (WIN_WIDTH / 2)); 
// 	obj->math_num.y_offset = (y - (WIN_WIDTH / 2)); 
...
int zoom_hook(int button, int x, int y, void *p) {
    ...
    obj = (main_obj *)p;
    double mouse_real = obj->math_num.real_num.min + (x * (obj->math_num.real_num.max - obj->math_num.real_num.min) / WIN_WIDTH);
    double mouse_imag = obj->math_num.imag_num.min + (y * (obj->math_num.imag_num.max - obj->math_num.imag_num.min) / WIN_HEIGHT);
